...
\begin{document}
  ...
  % \boldItem{Proficient}{Spark, Python, Presto, NumPy, SciPy, Pandas, Matplotlib, BeautifulSoup, PHP/Hack, React, R, C/C++, Bash, Linux, Git, Docker, Java, Maven, Jakarta EE, Selenium, \LaTeX}
